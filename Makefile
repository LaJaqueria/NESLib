...
$(BUILD_DIR)/neslib.lib: $(BUILD_DIR)/crt0.o $(BUILD_DIR)/neslib.o
	cp ${CC65_PATH}/lib/supervision.lib $(BUILD_DIR)/neslib.lib && ar65 a $(BUILD_DIR)/neslib.lib $(BUILD_DIR)/neslib.o $(BUILD_DIR)/crt0.o
...
zip: $(BUILD_DIR)/neslib.lib
	zip -r neslib-$(NDK_VERSION).zip $(INC_DIR)/* $(CFG_DIR)/* $(BUILD_DIR)/nes.lib $(EXAMPLES_DIR)/*
